...
- **Anti-sniping**: ставка в последние **15 секунд** продлевает раунд на **15 секунд**.
...
Ставка в последние 15 секунд раунда продлевает таймер на 30 секунд (Это демка так что не думаю, что это критично). Это предотвращает тактику "снайпинга" — перебивания ставок в последний момент.
